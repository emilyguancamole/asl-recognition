...
from hand_normalization import normalize_hands_full
from body_normalization import normalize_body_full


# Load the dataset
df = pd.read_csv("/Users/esther/Downloads/spoter-main/WLASL100_val_25fps.csv", encoding="utf-8")
...
df.to_csv("WLASL_normalized_train_25fps.csv", encoding="utf-8", index=False)
